...
public class EposUtils {
	...
	private Logger log = LoggerFactory.getLogger(EposUtils.class);

	@Autowired
	private UserRepository userRepository;

	/*
	 * public static boolean isNullOrEmpty(String param) { return param == null ||
	 * param.trim().length() == 0; }
	 */

	/*
	 * public static boolean isNullOrEmpty(List<?> element) { return element == null
	 * || element.isEmpty(); }
	 */
